...
<div class="form-group">
    ...
    <div class="col-sm-3">
        <?php echo $form->dropDownListCompare($oldModel,$model, 'sex',EmployList::getSexList(),
...
<div class="form-group">
    ...
    <div class="col-sm-3">
        <?php echo $form->dropDownListCompare($oldModel,$model, 'household',EmployList::getNationList(),
            array('disabled'=>($readonly))
        ); ?>
    </div>
</div>
<div class="form-group">
    ...
    <div class="col-sm-3">
        <?php echo $form->dropDownListCompare($oldModel,$model, 'health',EmployList::getHealthList(),
            array('disabled'=>($readonly))
        ); ?>
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-3">
        <?php echo $form->dropDownListCompare($oldModel,$model, 'staff_type',EmployList::getStaffTypeList(),
    ...
    <div class="col-sm-3">
        <?php echo $form->dropDownListCompare($oldModel,$model, 'staff_leader',EmployList::getStaffLeaderList(),
            array('disabled'=>($readonly))
        ); ?>
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-5">
        <?php echo $form->inlineRadioButtonListCompare($oldModel,$model, 'fix_time',EmployList::getFixTimeList(),
...
<div class="test-div">
    <div class="form-group">
        ...
        <div class="col-sm-3">
            <?php echo $form->dropDownListCompare($oldModel,$model, 'test_length',EmployList::getTestMonthLengthList(),
...
<div class="form-group">
    ...
    <div class="col-sm-3">
        <?php echo $form->dropDownListCompare($oldModel,$model, 'education',EmployList::getEducationList(),
            array('disabled'=>($readonly))
        ); ?>
    </div>
    <!--分割-->
