...
if (empty($model->id)&&$model->scenario != "new"){
    $this->redirect(Yii::app()->createUrl('holidayCon/index'));
}
$this->pageTitle=Yii::app()->name . ' - HolidayCon Form';
?>
...
<section class="content">
	...
	<div class="btn-group" role="group">
		<?php echo TbHtml::button('<span class="fa fa-reply"></span> '.Yii::t('misc','Back'), array(
				'submit'=>Yii::app()->createUrl('holidayCon/index',array("type"=>$model->type))));
		?>
        ...
        <?php if ($model->scenario!='view'): ?>
            <?php echo TbHtml::button('<span class="fa fa-upload"></span> '.Yii::t('misc','Save'), array(
                'submit'=>Yii::app()->createUrl('holidayCon/save')));
            ?>
            <?php if ($model->scenario=='edit'): ?>
...
?>
<?php
$js = Script::genDeleteData(Yii::app()->createUrl('holidayCon/delete'));
