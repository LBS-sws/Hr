<?php
$this->pageTitle=Yii::app()->name . ' - heartLetterAudit';
?>

<?php $form=$this->beginWidget('TbActiveForm', array(
    'id'=>'heartLetterAudit-list',
...
<section class="content-header">
    <h1>
        <strong><?php echo Yii::t('app','Audit Heart letter'); ?></strong>
    </h1>
    <!--
        <ol class="breadcrumb">
...
<section class="content">
    <div class="box"><div class="box-body">
            <div class="btn-group" role="group">
                ...
                if (Yii::app()->user->validRWFunction('FB02'))
                    echo TbHtml::button('<span class="fa fa-file-o"></span> '.Yii::t('misc','Add'), array(
                        'submit'=>Yii::app()->createUrl('heartLetterAudit/new'),
                    ));
                ?>
            </div>
        </div></div>
    ...
    $this->widget('ext.layout.ListPageWidget', array(
        ...
        'model'=>$model,
        'viewhdr'=>'//heartLetterAudit/_listhdr',
        'viewdtl'=>'//heartLetterAudit/_listdtl',
        'gridsize'=>'24',
        'height'=>'600',
